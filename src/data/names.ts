...
export const namesOfAllah: NameOfAllah[] = [
  ...
  ,
    "hadith": {
      "topic": "Hadith Qudsi",
      "arabic": "أَنَا الرَّحْمَنُ، خَلَقْتُ الرَّحِمَ، وَشَقَقْتُ لَهَا اسْمًا مِنْ اسْمِي، فَمَنْ وَصَلَهَا وَصَلْتُهُ، وَمَنْ قَطَعَهَا بَتَتُّهُ",
      "english": "I am Ar-Rahman (The Most Merciful). I created the Rahm (womb) and derived a name for it from My Name. Hence, whoever keeps it (family ties) I will keep ties with him, and whoever severs it, I will sever ties with him.",
  ...
  ,
    "hadith": {
      "arabic": "إِنَّ لِلَّهِ تِسْعَةً وَتِسْعِينَ اسْمًا مِائَةً إِلاَّ وَاحِدًا مَنْ أَحْصَاهَا دَخَلَ الْجَنَّةَ",
      "english": "Allah has ninety-nine names, i.e. one-hundred minus one, and whoever knows them will go to Paradise.",
  ...
  ,
    "hadith": {
      ...
      "arabic": "اسْمُ اللَّهِ الأَعْظَمُ فِي هَاتَيْنِ الآيَتَيْنِ ‏{‏وَإِلَهُكُمْ إِلَهٌ وَاحِدٌ لاَ إِلَهَ إِلاَّ هُوَ الرَّحْمَنُ الرَّحِيمُ‏}‏ وَفَاتِحَةِ سُورَةِ آلِ عِمْرَانَ ‏{‏اللَّهُ لاَ إِلَهَ إِلاَّ هُوَ الْحَىُّ الْقَيُّومُ‏}‏",
      "english": "The Greatest Name of Allah is in these two verses: 'And your god is one God. There is no deity [worthy of worship] except Him, the Entirely Merciful, the Especially Merciful' (2:163) and the opening of Surah Al-Imran 'Allah - there is no deity except Him, the Ever-Living, the Sustainer of [all] existence' (3:2).",
  ...
  ,
    "hadith": {
      "topic": "Allah's Patience",
      "arabic": "لَيْسَ أَحَدٌ أَوْ لَيْسَ شَىْءٌ أَصْبَرَ عَلَى أَذًى سَمِعَهُ مِنَ اللَّهِ، إِنَّهُمْ لَيَدْعُونَ لَهُ وَلَدًا، وَإِنَّهُ لَيُعَافِيهِمْ وَيَرْزُقُهُمْ",
      "english": "No one is more patient over hearing offensive words than Allah. They ascribe a son to Him, yet He preserves them and provides for them.",
